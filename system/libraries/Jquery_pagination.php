...
class Jquery_pagination{
	...
	function create_links()
	{
		...
		{
		$c_pages = ceil($this->cur_page / $this->per_page)+1;	
		}
		
		"start". $start = (($c_pages - $this->num_links) > 0) ? $c_pages - ($this->num_links) : 1;
		"end" .$end   = (($c_pages + $this->num_links) < $num_pages) ? $c_pages + $this->num_links : $num_pages;
